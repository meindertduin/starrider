...
struct Gradients {
    ...
    Gradients(const Vertex4D& min_y_vert, const Vertex4D mid_y_vert, const Vertex4D max_y_vert) {
        ...
        one_over_z[0] = 1.0f / min_y_vert.v.z;
        one_over_z[1] = 1.0f / mid_y_vert.v.z;
        one_over_z[2] = 1.0f / max_y_vert.v.z;

        // The w value is the perspective z value.
		text_coords[0] = min_y_vert.t * one_over_z[0];
		text_coords[1] = mid_y_vert.t * one_over_z[1];
		text_coords[2] = max_y_vert.t * one_over_z[2];
